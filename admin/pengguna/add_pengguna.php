...
if (isset($_POST['Simpan'])) {
	...
	if ($query_simpan) {
		echo "<script>
      Swal.fire({title: 'Tambah Pengguna Admin Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
		...
		echo "<script>
      Swal.fire({title: 'Tambah Pengguna Admin Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
      }).then((result) => {if (result.value){
