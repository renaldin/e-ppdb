...
<div class="card card-danger">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-edit"></i> Edit Tahun Ajaran
		</h3>
	</div>
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="id_tahun" name="id_tahun" value="<?php echo $data_cek['id_tahun']; ?>" readonly />
				</div>
			</div>
...
if (isset($_POST['Edit'])) {
	...
	if ($query_edit) {
		echo "<script>
      Swal.fire({title: 'Edit Tahun Ajaran Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
		...
		echo "<script>
      Swal.fire({title: 'Edit Tahun Ajaran Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
      }).then((result) => {if (result.value)
        {window.location = 'index.php?page=data-tahun';
        }
      })</script>";
