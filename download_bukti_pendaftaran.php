...
?>
    ...
    <head>
        <title>DOWNLOAD BUKTI PENDAFTARAN</title>
        <!-- Bootstrap core CSS -->
                ...
                <table style="width:100%">
                    <tr style="border-top: 1px solid black; border-left: 1px solid black; border-bottom: 1px solid black; border-collapse: collapse;">
                        <td rowspan="5" width="250px">
                            <center><img src="./assets/img/logo-e-ppdb.png" height="150px" width="150px" alt="Logo E-PPDB"></center>
                        </td>
                    </tr>
                    <tr style="border-right: 1px solid black; border-top: 1px solid black; border-collapse: collapse;">
                    ...
                    <tr style="border-right: 1px solid black; border-collapse: collapse;">
                        <td style="padding-left: 10px;"><span style="font-size: 30px;"><b><?= $data_cek['nama_sekolah'] ?></b></span></td>
                    </tr>
                    <tr style="border-right: 1px solid black; border-collapse: collapse;">
                    ...
                    <tr style="border-bottom: 1px solid black; border-right: 1px solid black; border-collapse: collapse;">
                        <td style="padding-left: 10px;">
                            <span style="font-size: 10px;">Alamat : Kp. Selagedang RT/RW 01/o3 Desa Sukalilah Kecamatan Cibatu
